...
class AccountSetting(object):
    ...
    def __create_widget(self):
        ...
        self.button_widgets["account_type"] = ComboBox([(_('Standard'), 0), (_('Administrator'), 1)], max_width=COMBO_WIDTH-5)
        ...
        self.button_widgets["account_type_new"] = ComboBox([(_('Standard'), 0), (_('Administrator'), 1)], max_width=COMBO_WIDTH-5)
    ...
    def password_change_press_cb(self, widget, event):
        ...
        action_combo = ComboBox(action_items, max_width=COMBO_WIDTH-5)
