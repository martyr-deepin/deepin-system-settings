...
class A11yManager:
    ...
    def __get_item_value(self, items, ori_value):
        for item, value in items:
            if ori_value == "nothing" and value == A11yManager.nothing:
                return value
            if ori_value == "hibernate" and value == A11yManager.hibernate:
                return value
            if ori_value == "shutdown" and value == A11yManager.shutdown:
                return value
